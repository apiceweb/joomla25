...
<form action="<?php echo JRoute::_('index.php?option=com_weblinks&view=weblinks'); ?>" method="post" name="adminForm" id="adminForm">
	<fieldset id="filter-bar"> <!-- selezioni sopra tabella -->
	...
	<table class="adminlist">
		...
		<tfoot> <!-- sintassi html si ordina lui in automatico -->
			<tr>
				<td colspan="10">
		...
		<tbody>
		<?php foreach ($this->items as $i => $item) : //lista preparata dalla view.html.php -> chiave valore per differenziare bkg colore righe pari e dispari
	...
	<?php if ($user->authorize('core.create', 'com_weblinks') && $user->authorize('core.edit', 'com_weblinks') && $user->authorize('core.edit.state', 'com_weblinks')) : ?>
